                ...
                <div class="card-body d-lg-flex d-xxl-flex justify-content-between align-items-lg-center align-items-xxl-center" style="padding: 13px;padding-right: 25px;">
                    ...
                    <div style="padding-bottom: 40px;">
                        <div style="text-align: center;">
                            ...
                            <div><a href="#" style="background: var(--bs-blue);padding: 11px;padding-right: 30px;padding-left: 30px;color: var(--bs-card-bg);font-family: 'Open Sans', sans-serif;">Select</a></div>
                        </div>
                    </div>
                </div>
            </div>
